...
== More comfortable
If you yourself are more comfortable with the material, maybe because you already have some programming experience or you just like to challenge yourself a bit more, then this is the assigment for you [Find (more comfortable)](/problems/find-more).

Otherwise implement find as specified below.
...
[source,subs="macros"]
----
$ wget https://github.com/cs50/distro/archive/find.zip
$ unzip find.zip
$ rm find.zip
