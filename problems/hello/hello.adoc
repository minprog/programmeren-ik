...
Be sure to register for an account at link:https://github.com/[GitHub] and then head to link:https://cs50.me/[CS50.me] to enable ``check50``!
After you have done this you will receive two emails on the email adress you used to register at Github. Click the invitation links in both and accept them.

Be sure to install the newest version of check by executing the following command in the terminal
