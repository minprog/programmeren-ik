...
. Implement link:/problems/hello_py[hello.py]
. Implement link:/problems/mario_py[mario.py]
. Implement link:/problems/greedy_py[greedy.py]
. Implement link:/problems/vigenere_py[vigenere.py]
