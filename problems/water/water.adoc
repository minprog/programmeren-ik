...
== Steps
This problem looks quite a bit like the `ints.c` program from link:/lectures/c[lecture]. Study the examples atop this document and think about which parts of `ints.c` you might reuse in your solution. Then, create a file `water.c` and try to make it work.
